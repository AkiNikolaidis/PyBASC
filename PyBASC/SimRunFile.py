...
roi_mask_file='masks/Yeo7_3mmMasks/BilateralStriatumThalamus_3mm.nii.gz'
...
run=True
analysis_ID='test_run5'
reruns= 1


main(dataset_bootstrap_list,timeseries_bootstrap_list, similarity_metric_list, 
