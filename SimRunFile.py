...
reruns=np.linspace(1,1,1)

dataset_bootstraps_list=[1]#,10,30,100]
                ...
                for blocklength in blocklength_list:
                        for n_clusters in n_clusters_list:
                            for output_size in output_sizes:
                                ...
                                #out_dir= '/users/aki.nikolaidis/PyBASC_outputs/SimTesting/dim_' + str(output_size) + '_' + str(similarity_metric) + '_' + str(n_clusters) + '_clusters_' +str(timeseries_bootstraps) +'_IndBS_' + str(blocklength) + '_block' + similarity_metric
                                out_dir= '/users/aki.nikolaidis/PyBASC_outputs/NewSpatialConstraintTest' + str(int(rerun)) + '_' + str(dataset_bootstraps) + 'GS' +'/' + str(n_clusters) + '_clusters'
